...
public class FullApkSignTest {
  ...
  public void testSignature() throws Exception {
    ...
    ApkZLibPair<PrivateKey, X509Certificate> signData = SignatureTestUtils.generateSignaturePre18();
    ...
    new SigningExtension(13, signData.v2, signData.v1, false, true).register(zf);
    String f1Name = "abc";
